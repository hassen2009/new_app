...
class addtocours3 extends StatefulWidget {
  const addtocours3({Key? key}) : super(key: key);
  @override
  State<addtocours3> createState() => _addtocours3State();
}
class _addtocours3State extends State<addtocours3> {
  String role = "user";
  _checkrole()async{
  ...
  Future<String> uploadPdf(String fileName,File file) async {
    final reference = FirebaseStorage.instance.ref().child("pdfscourss3/$fileName.pdf");
  ...
  void getAllPdf()async{
    final result = await  _firebaseFirestore.collection("pdfscourss3").get();
