              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                      ...
                      child: Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              IconButton(onPressed: ()=> create(), icon: Icon(Icons.add_circle,color: Get.isDarkMode?Colors.black:Colors.white,))
                            ],)
                      ),
                    ),
                    SizedBox(height: 10,),
                    Container(
                      //color: Colors.red,
                      child: StreamBuilder(stream: _cour.snapshots(), builder: (context,AsyncSnapshot<QuerySnapshot> streamsnapshot){
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                      ...
                      child: Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              IconButton(onPressed: ()=> createm(), icon: Icon(Icons.add_circle,color: Get.isDarkMode?Colors.black:Colors.white,))
                            ],)
                      ),
                    ),
                    SizedBox(height: 10,),
                    Container(
                      //color: Colors.red,
                      child: StreamBuilder(stream: _mardi.snapshots(), builder: (context,AsyncSnapshot<QuerySnapshot> streamsnapshot){
                        if(streamsnapshot.hasData){
                          return ListView.builder(
                              shrinkWrap: true,
                              scrollDirection: Axis.vertical,
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                      ...
                      child: Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              IconButton(onPressed: ()=> createmer(), icon: Icon(Icons.add_circle,color: Get.isDarkMode?Colors.black:Colors.white,))
                            ],)
                      ),
                    ),
                    SizedBox(height: 10,),
                    Container(
                      //color: Colors.red,
                      child: StreamBuilder(stream: _mercredi.snapshots(), builder: (context,AsyncSnapshot<QuerySnapshot> streamsnapshot){
                        if(streamsnapshot.hasData){
                          return ListView.builder(
                              shrinkWrap: true,
                              scrollDirection: Axis.vertical,
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                      ...
                      child: Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              IconButton(onPressed: ()=> createjeu(), icon: Icon(Icons.add_circle,color: Get.isDarkMode?Colors.black:Colors.white,))
                            ],)
                      ),
                    ),
                    SizedBox(height: 10,),
                    Container(
                      //color: Colors.red,
                      child: StreamBuilder(stream: _jeudi.snapshots(), builder: (context,AsyncSnapshot<QuerySnapshot> streamsnapshot){
                        if(streamsnapshot.hasData){
                          return ListView.builder(
                              shrinkWrap: true,
                              scrollDirection: Axis.vertical,
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                      ...
                      child: Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              IconButton(onPressed: ()=>createven(), icon: Icon(Icons.add_circle,color: Get.isDarkMode?Colors.black:Colors.white,))
                            ],)
                      ),
                    ),
                    SizedBox(height: 10,),
                    Container(
                      //color: Colors.red,
                      child: StreamBuilder(stream: _vendredi.snapshots(), builder: (context,AsyncSnapshot<QuerySnapshot> streamsnapshot){
                        if(streamsnapshot.hasData){
                          return ListView.builder(
                              shrinkWrap: true,
                              scrollDirection: Axis.vertical,
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                      ...
                      child: Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              IconButton(onPressed: ()=>createsam(), icon: Icon(Icons.add_circle,color: Get.isDarkMode?Colors.black:Colors.white,))
                            ],)
                      ),
                    ),
                    SizedBox(height: 10,),
                    Container(
                      //color: Colors.red,
                      child: StreamBuilder(stream: _samedi.snapshots(), builder: (context,AsyncSnapshot<QuerySnapshot> streamsnapshot){
                        if(streamsnapshot.hasData){
                          return ListView.builder(
                              shrinkWrap: true,
                              scrollDirection: Axis.vertical,
